...
#define init_board(g)          SSD1327_init_board()
#define post_init_board(g)     SSD1327_post_init_board()
#define setpin_reset(g, state) SSD1327_setpin_reset(state)
#define acquire_bus(g)         SSD1327_aquirebus()
#define release_bus(g)         SSD1327_releasebus()
#define write_cmd(g, cmd)      SSD1327_write_cmd(cmd)
#define write_data(g, data)    SSD1327_write_data(data)
