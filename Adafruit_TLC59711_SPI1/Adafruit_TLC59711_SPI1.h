...
#ifndef _Adafruit_TLC59711_SPI1_H
#define _Adafruit_TLC59711_SPI1_H

#include <Arduino.h>


class Adafruit_TLC59711_SPI1 {
 public:
  Adafruit_TLC59711_SPI1(uint8_t n, uint8_t c, uint8_t d);
  Adafruit_TLC59711_SPI1(uint8_t n);
