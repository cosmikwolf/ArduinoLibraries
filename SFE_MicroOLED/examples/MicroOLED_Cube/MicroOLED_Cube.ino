...
void drawCube()
{
  r[0]=r[0]+PI/360.0; // Add a degree
  r[1]=r[1]+PI/360.0; // Add a degree
  r[2]=r[2]+PI/360.0; // Add a degree
  if (r[0] >= 360.0*PI/360.0) r[0] = 0;
  if (r[1] >= 360.0*PI/360.0) r[1] = 0;
  if (r[2] >= 360.0*PI/360.0) r[2] = 0;
